(function () {
  ...
  function createRegistry(host) {
    ...
    var GALGAME_STYLE_ID = "st-galgame-narrative-bootstrap-style-v2";
    ...
    function clampPosition(x, y) {
      ...
      var upperX = Math.max(8, host.innerWidth - width - sidecar - 8);
      var lowerX = panel?.classList?.contains("profile-neighbors") && upperX >= 82 ? 82 : 8;
      return {
    ...
    function shellCss() {
      return [
        ...
        ".work-lever-host{position:absolute;z-index:8;left:-112px;top:164px;width:150px;height:206px;display:none;pointer-events:none;filter:drop-shadow(0 18px 15px rgba(0,0,0,.58));user-select:none}.panel.work-lever-visible .work-lever-host{display:block}.work-lever{position:absolute;left:0;top:0;width:150px;height:206px;border:0;padding:0;background:transparent;pointer-events:auto;cursor:grab;touch-action:none}.work-lever:active,.work-lever.is-pulling{cursor:grabbing}.work-lever__shaft{position:absolute;z-index:1;left:53px;top:99px;width:97px;height:30px;border:5px solid #0b0e0c;border-radius:999px;background:linear-gradient(180deg,#8e9a92 0 20%,#4b574f 38% 68%,#202923 84% 100%);box-shadow:inset 0 5px rgba(255,255,255,.13),5px 6px 0 rgba(0,0,0,.4)}.work-lever__pivot{position:absolute;z-index:3;left:40px;top:91px;width:46px;height:46px;border:6px solid #0b0e0c;border-radius:50%;background:radial-gradient(circle at 35% 30%,#b7c2ba,#49554e 56%,#17201a 100%);box-shadow:inset -5px -6px rgba(0,0,0,.25),6px 7px 0 rgba(0,0,0,.42)}.work-lever__frame-mask{position:absolute;z-index:4;right:23px;top:88px;width:15px;height:54px;border-inline:3px solid rgba(133,150,139,.45);background:linear-gradient(90deg,#111814,#2f3a34 48%,#0b0f0c);box-shadow:inset 2px 0 rgba(255,255,255,.08),3px 0 rgba(0,0,0,.55);pointer-events:none}.work-lever__handle{position:absolute;z-index:2;left:0;top:0;width:76px;height:120px;transform-origin:63px 114px;transform:rotate(-17deg);transition:transform .3s cubic-bezier(.18,.82,.25,1.18)}.work-lever__arm{position:absolute;left:53px;top:40px;width:22px;height:82px;border:5px solid #111814;border-radius:999px;background:linear-gradient(90deg,#aab4ad,#46534b 62%,#222b25);box-shadow:inset 4px 0 rgba(255,255,255,.14),4px 5px 0 rgba(0,0,0,.35)}.work-lever__knob{position:absolute;left:14px;top:0;width:72px;height:70px;border:6px solid #0b0d0c;border-radius:50% 44% 51% 46%;background:radial-gradient(circle at 34% 28%,#ffcf68 0 8%,#d97706 28%,#8f330c 66%,#421507 100%);box-shadow:inset -8px -10px rgba(44,12,3,.3),7px 9px 0 rgba(0,0,0,.42)}.work-lever__tag{position:absolute;left:0;top:67px;padding:5px 8px;border:3px solid #101310;background:#e9e1c9;color:#111814;font:950 10px/1 Impact,'Arial Black',sans-serif;letter-spacing:.08em;transform:rotate(-8deg);box-shadow:4px 4px 0 #d97706}.work-lever.is-pulling .work-lever__handle{transform:rotate(-69deg);transition-duration:.17s}@media(max-width:760px){.work-lever-host{left:-102px;transform:scale(.92);transform-origin:right top}}",
    ...
    function updateWorkLever(payload) {
      ...
      if (visible && Number.isFinite(axisY)) {
        workLeverHost.style.top = Math.max(18, axisY - 114) + "px";
      }
