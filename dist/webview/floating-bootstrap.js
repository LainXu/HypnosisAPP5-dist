(function () {
  ...
  function createRegistry(host) {
    ...
    var profilePossessionRear = null;
    ...
    function shellCss() {
      return [
        ...
        ".profile-possession-rear,.profile-possession-host{position:absolute;left:50%;bottom:-128px;width:300px;height:200px;transform:translateX(-50%) rotate(-1.5deg);display:none}.panel.profile-possession-visible .profile-possession-rear,.panel.profile-possession-visible .profile-possession-host{display:block}.profile-possession-rear{z-index:3;pointer-events:none;overflow:visible}.profile-possession-host{z-index:9;pointer-events:none;overflow:hidden;clip-path:inset(0 0 58% 0)}.profile-possession-rear img,.profile-possession-grip img{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;display:block;user-select:none;-webkit-user-drag:none}.profile-possession-rear img{opacity:.48;filter:grayscale(.28) saturate(.72) blur(1.35px);transform:translate(3px,5px);transition:opacity .25s ease,filter .25s ease,transform .25s ease}.profile-possession-grip{position:absolute;inset:0;border:0;padding:0;background:transparent;pointer-events:auto;cursor:pointer;touch-action:manipulation;filter:grayscale(.22) saturate(.8);opacity:.64;transform:translate(2px,2px);transition:transform .25s cubic-bezier(.2,.85,.22,1),filter .25s ease,opacity .25s ease}.profile-possession-grip:after{content:'';position:absolute;inset:0;background:url('" + escapeHtml(String(config.assetBase || "").replace(/\/?$/, "/") + "profile-ui/profile-possession-grip-v4.png") + "') center/contain no-repeat;opacity:.18;filter:blur(5px);transform:translate(-7px,3px);pointer-events:none}.profile-possession-grip:hover{opacity:.82;transform:translateY(-4px) rotate(.6deg)}.profile-possession-grip:active{transform:translateY(1px) scale(.985)}.profile-possession-rear.active img{opacity:.96;filter:saturate(1.08) contrast(1.04);transform:none}.profile-possession-grip.active{opacity:1;filter:saturate(1.08) contrast(1.04);transform:none}.profile-possession-grip.active:after{opacity:.08;filter:blur(3px);transform:translate(-3px,2px)}",
    ...
    function updateProfilePossession(payload) {
      ...
      profilePossessionRear?.classList?.toggle("active", active);
    ...
    function ensureShell() {
      ...
      profilePossessionRear = shadow.querySelector(".profile-possession-rear");
