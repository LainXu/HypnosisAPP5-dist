  ...
  function createRegistry(host) {
    ...
    function shellCss() {
      return [
        ...
        ".raven-perch-rear,.raven-perch-claw{position:absolute;left:50%;top:-181px;width:calc(100% + 140px);height:190px;object-fit:contain;object-position:center bottom;transform:translateX(-50%) rotate(-.35deg);pointer-events:none;user-select:none;-webkit-user-drag:none}.raven-perch-rear{z-index:3;filter:drop-shadow(0 16px 12px rgba(0,0,0,.66)) saturate(.96) contrast(1.09)}.raven-perch-claw{z-index:8;filter:drop-shadow(0 5px 2px rgba(0,0,0,.58)) saturate(.98) contrast(1.1);transform:translateX(-50%) translateY(8px) rotate(-.35deg)}.raven-perch-claw.left{clip-path:polygon(39% 72%,53% 72%,53% 100%,39% 100%)}.raven-perch-claw.right{clip-path:polygon(57% 72%,71% 72%,71% 100%,57% 100%)}.panel.profile-possession-visible .raven-perch-rear,.panel.profile-possession-visible .raven-perch-claw{display:none}",
    ...
    function ensureShell() {
      ...
      var ravenAsset = String(config.assetBase || "").replace(/\/?$/, "/") + "profile-ui/hypnosis-raven-top-perch-v6.png";
      [
        { className: "raven-perch-rear" },
        { className: "raven-perch-claw left" },
        { className: "raven-perch-claw right" }
      ].forEach(function (ravenLayer) {
        var image = hostDocument.createElement("img");
        image.className = ravenLayer.className;
        image.alt = "";
        image.draggable = false;
        image.src = ravenAsset;
