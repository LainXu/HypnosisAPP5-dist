  ...
  function createRegistry(host) {
    ...
    function shellCss() {
      return [
        ...
        ".hypnosis-judgement-perch{position:absolute;z-index:3;left:50%;top:-202px;width:calc(100% + 158px);height:218px;transform:translateX(-50%);display:none;pointer-events:none;user-select:none;-webkit-user-drag:none;isolation:isolate}.panel.hypnosis-perch-visible:not(.profile-possession-visible) .hypnosis-judgement-perch{display:block}.hypnosis-judgement-perch__rear,.hypnosis-judgement-perch__front{position:absolute;inset:0;width:100%;height:100%;object-fit:contain;object-position:center bottom;user-select:none;-webkit-user-drag:none}.hypnosis-judgement-perch__rear{z-index:1;filter:drop-shadow(0 17px 13px rgba(0,0,0,.64)) saturate(.84) contrast(1.08)}.hypnosis-judgement-perch__front{z-index:7;clip-path:inset(72% 0 0 0);filter:drop-shadow(0 5px 3px rgba(0,0,0,.72)) saturate(.88) contrast(1.1)}",
